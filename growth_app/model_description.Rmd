...
* $r_d$ is the discrete growth factor. 
    * $r=0$ is no growth
...
* $\lambda$ is the finite rate of increase
    * $\lambda \gtrapprox 1.02$ is positive growth 
    * $\lambda \lessapprox 1.01$ is negative growth
* $K$ is the carrying capacity

Note that in this density dependent model there are two points of stability: $N=0$ (extinction or extirpation) and $K$. Unlike equation 1, in equation 2, $K$ changes depending on the growth rate $\lambda$. For Example, if $\lambda = 2$ the population stabalises at $K/2$. This is not the case for the continuous exponential model which is not covered here.
...
* __Growth is continuous without time lags:__ individuals are considered as being born and dying continuously and the rate of increase instantaneously as population size increases without discrete generations. Growth rate remains constant through time without stochasticity.
...
* __Carrying capacity:__ Resource availability remains constant through time excluding any variability or stochasticity.
...
More complicated variations of these models address the limitations of assumptions outlined above. In reality violating some of these assumption could be fatal to the accuracy of population projections depending on the population of interest although they show in basic terms the principles of logistic population growth.
