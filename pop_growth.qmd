...
## Part 1: Exponential population growth {background-color="#1a1a2e"}
...
## Assumptions of the exponential model {background-color="#1a1a2e"}
...
## Part 2: Logistic population growth {background-color="#1a1a2e"}
...
## Assumptions of the logistic model {background-color="#1a1a2e"}
...
## Part 3: Introducing stochasticity {background-color="#1a1a2e"}
...
## Go forth and model! {background-color="#1a1a2e"}
